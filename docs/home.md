...
Two tools that sit alongside your existing Figma workflow — one for thinking, one for checking.

<div class="card-grid">
  <a class="card" href="#/tools/design-workflow-skill">
    <span class="card-icon">💬</span>
    <p class="card-title">Design Workflow Skill</p>
    <p class="card-desc">Turns your NEED inputs into a design brief. Checks your screens before a sync. Runs in Claude chat — no setup needed.</p>
  </a>
...
NEED arrives
    ↓
[Skill] Synthesise inputs → design brief
    ↓
Open Figma
    ↓
[Skill] Check screens before sync → fix blockers
    ↓
Weekly sync
    ↓
Screens on staging
    ↓
[Agent] Full audit → structured report
    ↓
Handoff
```
